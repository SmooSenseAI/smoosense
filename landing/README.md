...
## Key features
- Fast browsing of large datasets with integrated media visualization
- Interactive, graphical data analysis with automated drill-through
  Visualize patterns, filter with natural language, and pivot into subsets effortlessly—turning raw multimodal data into insights with a few clicks.

- First-class embedding support
  - Similarity search
  - 2D visualization
  - Clustering