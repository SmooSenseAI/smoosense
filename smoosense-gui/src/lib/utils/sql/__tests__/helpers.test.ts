...
describe('sanitizeName', () => {
  ...
  describe('should always wrap names in double quotes', () => {
    it('should wrap simple column names in double quotes', () => {
      expect(sanitizeName('column_name')).toBe('"column_name"')
      expect(sanitizeName('id')).toBe('"id"')
      expect(sanitizeName('user_id')).toBe('"user_id"')
    })

    it('should wrap each part of table.column format in double quotes', () => {
